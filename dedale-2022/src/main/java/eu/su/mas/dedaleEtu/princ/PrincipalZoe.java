...
public class PrincipalZoe {
    ...
    public static void main(String[] args){
        ...
        if(ConfigurationFileZoe.COMPUTERisMAIN){
            ...
            containerList.putAll(createAndConnectContainer(ConfigurationFileZoe.LOCAL_CONTAINER_NAME, ConfigurationFileZoe.PLATFORM_HOSTNAME, ConfigurationFileZoe.PLATFORM_ID, ConfigurationFileZoe.PLATFORM_PORT));
    ...
    private static Runtime emptyPlatform(HashMap<String, ContainerController> containerList){
        ...
        Profile pMain = new ProfileImpl(ConfigurationFileZoe.PLATFORM_HOSTNAME,ConfigurationFileZoe.PLATFORM_PORT,ConfigurationFileZoe.PLATFORM_ID);
    ...
    private static HashMap<String,ContainerController> createAndConnectContainer(String containerName,String host, String platformID, Integer port){
        ...
        if (port==null){
            port=ConfigurationFileZoe.PLATFORM_PORT;
        }
    ...
    private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
        ...
        if (ConfigurationFileZoe.COMPUTERisMAIN){
             ...
             */
            c = containerList.get(ConfigurationFileZoe.LOCAL_CONTAINER_NAME);
